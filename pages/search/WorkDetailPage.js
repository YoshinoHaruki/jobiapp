        ...
        <div className='cont_jobdetailpage'>
            <View style={css.cont_white}>
                   ...
                   
                    {
                        ...
                        <View>
                            ...
                            <View style={styles.txt_thing}>
                                {belongs.uniform && <View><Text>私服OK</Text></View>}
                                {belongs.shoes && <View><Text>シューズ貸し出し</Text></View>}
                                {belongs.pen && <View><Text>筆記用具</Text></View>}
                                {belongs.snack && <View><Text>飲み物・軽食</Text></View>}
                            </View>
                        </View>
                    }
                ...
                </View>
                {
                    ...
                    :
                    (
                        userStatus == 0 && <Pressable onPress={() => { props.navigation.navigate("CertificatePage", { state: { id: id } }) }}> <View style={[css.btn_yellow, styles.btn_yellow]} >本人確認にすすむ</View> </Pressable> ||
                        userStatus == 1 && <View style={[css.btn_yellow, styles.txt_waiting]}>本人確認資料を確認中</View> ||
                        userStatus == 2 &&
