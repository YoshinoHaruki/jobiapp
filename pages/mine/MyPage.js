            ...
            <View style={styles.board}>
                ...
                <View style={styles.box_circle}>
                    <View style={styles.inner_circle}>
                        ...
                        <Text style={styles.txt_circle2}>{basic_info?.level}</Text>
                    </View>
                </View> */}
                {/* <Text style={styles.ttl_percent}>Good率</Text>
                <Text style={styles.txt_percent}>{basic_info?.good_rate}%</Text> */}
                    ...
                    reviews.map((item, index) =>
                        <View style={styles.item_review} key={index}>
                            <View style={styles.item_review_header}>
                                ...
                                {
                                    showReviewMoreIndex != index && <Text style={styles.txt_more}>{cutString(item.comment, 5)}</Text>
                                }
                            ...
                            {
                                showReviewMoreIndex == index && <Text style={styles.txt_review}>{item.comment}</Text>
                            }
                        </View>
                    )
                }
