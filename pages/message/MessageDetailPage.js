    ...
    return (
        <View style={[css.cont_white, styles.cont]}>
            ...
            <View style={styles.board}>
                ...
                <input type="file" onChange={updateAttach} ref={attachRef} style={{display:"none"}} accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*"/>        
            </View>
            <View style={styles.box_input}>
                ...
                <Pressable onPress={()=>{attachRef.current.click()}}> <Image source={camera} style={styles.camera} /></Pressable>
