...
export default function RegistPage4(props) {
    ...
    return (
        <View style={css.cont_blue}>
            ...
            <TextInput value={email} style={[css.input, conform && styles.input_ok]} placeholder={!conform && '入力'} onChangeText={(text)=>{setMailError("");setEmail(text)}}/>
            <Text style={styles.error}>{mailError}</Text> */}
